    ...
    <div className="bg-[#FAFAFA] min-h-screen text-[#111111] font-sans selection:bg-[#C34A36] selection:text-white pb-10">
      ...
      <div className="bg-[#111111] text-white py-3 px-4 text-center text-sm font-semibold flex flex-col sm:flex-row items-center justify-center gap-2 relative z-50">
        ...
        <div className="flex items-center gap-4">
          <Link href="/ruang-rupa" className="underline hover:text-[#C34A36] transition-colors">
            Lihat versi Mini
          </Link>
          <span className="text-gray-600">|</span>
          <Link href="/ruang-rupa-basic" className="underline hover:text-[#C34A36] transition-colors">
            Lihat versi Basic
          </Link>
        </div>
      </div>
      ...
      <footer className="bg-[#111111] text-white pt-20 pb-10 px-6 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <a href="/ruang-rupa-full/admin" className="text-xs font-bold text-gray-500 hover:text-white uppercase tracking-wider underline">Akses Dashboard Admin Demo</a>
          </div>
          <div>
