...
export default function PaymentPage() {
  ...
  useEffect(() => {
    ...
    if (cart.length === 0) {
      ...
      router.push("/demo/kopi-semesta-full/order");
    }
    ...
    <div className="min-h-screen bg-[#F5EFE6] text-[#3D2B1F] font-sans pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Link href="/demo/kopi-semesta-full/order" className="p-2 hover:bg-white rounded-full transition-colors text-[#B36A5E]">
            <ArrowLeft size={24} />
          </Link>
