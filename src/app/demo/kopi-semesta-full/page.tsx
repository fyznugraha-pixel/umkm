...
export default function KopiSemestaFullDemo() {
  ...
  const CartIcon = (
    <Link 
      href="/demo/kopi-semesta-full/keranjang"
  ...
  const AdminButton = (
    <a 
      href="/demo/kopi-semesta-full/admin"
    ...
    <div className="bg-[#F5EFE6] min-h-screen text-[#3D2B1F] font-sans pb-10">
      ...
      <div className="bg-[#B36A5E] text-white py-3 px-4 text-center text-sm font-semibold flex flex-col sm:flex-row items-center justify-center gap-4 relative z-50">
        ...
        <div className="flex gap-4">
          <a href="/demo/kopi-semesta" className="underline text-yellow-200 hover:text-white transition-colors">
            Versi Mini &rarr;
          </a>
          <a href="/demo/kopi-semesta-basic" className="underline text-yellow-200 hover:text-white transition-colors">
            Versi Basic &rarr;
          </a>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#F5EFE6]/70">
              ...
              <li><a href="/demo/kopi-semesta-full/admin" className="hover:text-white font-bold text-[#B36A5E] transition-colors mt-2 inline-block">Login Admin &rarr;</a></li>
            </ul>
          </div>
          <div>
