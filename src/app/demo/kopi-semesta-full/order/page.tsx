...
export default function OrderPage() {
  ...
  useEffect(() => {
    if (cart.length === 0) {
      router.push("/demo/kopi-semesta-full/keranjang");
    }
  }, [cart, router]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push("/demo/kopi-semesta-full/payment");
  };
    ...
    <div className="min-h-screen bg-[#F5EFE6] text-[#3D2B1F] font-sans pt-12 pb-20 bg-[url('/noise.png')]">
      <div className="max-w-2xl mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Link href="/demo/kopi-semesta-full/keranjang" className="p-2 hover:bg-white/50 rounded-full transition-colors text-[#B36A5E]">
            <ArrowLeft size={24} />
          </Link>
