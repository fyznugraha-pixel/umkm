    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#111111] font-sans pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        <div className="flex items-center gap-4 mb-8 border-b border-gray-200 pb-6">
          <Link href="/demo/ruang-rupa-full" className="p-2 hover:bg-gray-100 rounded-full transition-colors">
            <ArrowLeft size={24} />
          </Link>
        ...
        {cart.length === 0 ? (
          <div className="text-center py-20 bg-white border border-gray-200 rounded-2xl">
            ...
            <Link 
              href="/demo/ruang-rupa-full#katalog"
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="w-full lg:w-80 shrink-0">
              <div className="bg-[#111111] text-white p-6 rounded-2xl sticky top-24">
                ...
                <Link 
                  href="/demo/ruang-rupa-full/order"
